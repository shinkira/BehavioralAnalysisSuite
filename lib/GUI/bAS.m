...
set(guiObjects.figHandle,'OuterPosition',[scrn(1)+0.3*scrn(3) scrn(2)+0.1*scrn(4) 0.7*scrn(3) 0.75*scrn(4)]);

guiObjects.table = uitable('FontName','Arial','FontSize',14,'RowStriping','on','BackgroundColor',...
    [1 1 1; 0.8 0.8 0.8],'Units','normalized','Position',[0 .32 1 .28]);

%create start live acquisition button
guiObjects.startStop = uicontrol('FontName','Arial','FontSize',15,'FontWeight','bold',...
    'ForegroundColor',[0 0 0],'Units','Normalized','Position',[.025 .15 .2 .03],...
    'String','Start Live Aq','Style','pushbutton','BackgroundColor',[0.7969 0.7969 0.7969]);
...
guiObjects.condDisp(1) = uicontrol('FontName','Arial','FontSize',15,'FontWeight','bold',...
    'ForegroundColor',[0 0 0],'Units','Normalized','Position',[0.65 0.605 0.2 0.02],...
...
guiObjects.condDisp(2) = uicontrol('FontName','Arial','FontSize',15,'FontWeight','bold',...
    'ForegroundColor',[0 0 0],'Units','Normalized','Position',[0.77 0.605 0.3 0.02],...
...
guiObjects.zoomButton = uicontrol('ForegroundColor',[0 0 0],'Units','Normalized',...
    'Position',[0.56 0.605 0.03 0.0225],'Style','pushbutton','BackgroundColor',[0.7969 0.7969 0.7969],...
    'cdata',Zoom_In,'enable','off');
guiObjects.panButton = uicontrol('ForegroundColor',[0 0 0],'Units','Normalized',...
    'Position',[0.6 0.605 0.03 0.0225],'Style','pushbutton','BackgroundColor',[0.7969 0.7969 0.7969],...

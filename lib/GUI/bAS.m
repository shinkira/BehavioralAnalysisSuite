...
guiObjects.table = uitable('FontName','Arial','FontSize',12,'RowStriping','on','BackgroundColor',...
    [1 1 1; 0.8 0.8 0.8],'Units','normalized','Position',[0 .32 1 .35]); % [0 .32 1 .28]
...
guiObjects.zoomButton = uicontrol('ForegroundColor',[0 0 0],'Units','Normalized',...
    'Position',[0.56 0.675 0.03 0.0225],'Style','pushbutton','BackgroundColor',[0.7969 0.7969 0.7969],...
    'cdata',Zoom_In,'enable','off');
guiObjects.panButton = uicontrol('ForegroundColor',[0 0 0],'Units','Normalized',...
    'Position',[0.6 0.675 0.03 0.0225],'Style','pushbutton','BackgroundColor',[0.7969 0.7969 0.7969],...
